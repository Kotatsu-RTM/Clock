...
public class JcwaStyleTwelveHourClockConverterTest {
    private final TestCase testCase;

    public JcwaStyleTwelveHourClockConverterTest(TestCase testCase) {
    ...
    public static Iterable<TestCase> data() {
        return Arrays.asList(
                ...
                new TestCase(6_000, 0, 0, false, true, "00:00 PM"),
                new TestCase(6_999, 0, 59, false, true, "00:59 PM"),
                ...
                new TestCase(18_000, 0, 0, true, false, "00:00 AM"),
                new TestCase(18_999, 0, 59, true, false, "00:59 AM"),
    ...
    public void getHourTest() {
        Assert.assertEquals(
                ...
                JcwaStyleTwelveHourClockConverter.getInstance().getHour(testCase.worldTime)
        );
    }
    ...
    public void getMinuteTest() {
        Assert.assertEquals(
                ...
                JcwaStyleTwelveHourClockConverter.getInstance().getMinute(testCase.worldTime)
        );
    }
    ...
    public void isAmTest() {
        Assert.assertEquals(
                ...
                JcwaStyleTwelveHourClockConverter.getInstance().isAm(testCase.worldTime)
        );
    }
    ...
    public void isPmTest() {
        Assert.assertEquals(
                ...
                JcwaStyleTwelveHourClockConverter.getInstance().isPm(testCase.worldTime)
        );
    }
    ...
    public void getFormattedTextTest() {
        Assert.assertEquals(
                ...
                JcwaStyleTwelveHourClockConverter.getInstance().getFormattedText(testCase.worldTime)
        );
    }
